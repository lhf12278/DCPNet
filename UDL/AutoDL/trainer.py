...
from UDL.mmcv.mmcv.utils.logging import print_log, create_logger
# 1.5s
from UDL.mmcv.mmcv.runner import init_dist, find_latest_checkpoint
from UDL.mmcv.mmcv.parallel import MMDataParallel, MMDistributedDataParallel
from UDL.mmcv.mmcv.runner import (DistSamplerSeedHook, EpochBasedRunner,
...
def trainer(cfg, logger,
    ...
    for flow in cfg.workflow:
        ...
        if 'val' in mode:
            ...
            from UDL.mmcv.mmcv.runner import EvalHook, DistEvalHook
