...
class panshaprening_cfg(TaskDispatcher, name='pansharpening'):
    ...
    def __init__(self, cfg=None, arch=None):
        ...
        if platform.system() == 'Linux':
            cfg.data_dir = '/home/l/data/yxj/01-DL-toolbox-Pytorch/UDL/Data/pansharpening'
        if platform.system() == "Windows":
            cfg.data_dir = 'D:/My--Study/My work/DLPan-Toolbox-main/01-DL-toolbox-Pytorch/UDL/Data/pansharpening'
